/**
 * Loader generated by glad 2.0.6 on Mon Aug  5 08:41:17 2024
 *
...
static const VkPipelineCreateFlagBits2KHR VK_PIPELINE_CREATE_2_ENABLE_LEGACY_DITHERING_BIT_EXT = 17179869184;
...
typedef struct GladVulkanContext {
    ...
    int EXT_legacy_vertex_attributes;
    int EXT_line_rasterization;
    int EXT_load_store_op_none;
    int EXT_map_memory_placed;
    ...
    int EXT_shader_replicated_composites;
    ...
    int IMG_relaxed_line_rasterization;
    ...
    int KHR_shader_expect_assume;
    int KHR_shader_float16_int8;
    int KHR_shader_float_controls;
    int KHR_shader_float_controls2;
    int KHR_shader_integer_dot_product;
    int KHR_shader_maximal_reconvergence;
    int KHR_shader_non_semantic_info;
    int KHR_shader_quad_control;
    int KHR_shader_relaxed_extended_instruction;
    int KHR_shader_subgroup_extended_types;
    int KHR_shader_subgroup_rotate;
    ...
    int MESA_image_alignment_control;
    int MSFT_layered_driver;
    int MVK_ios_surface;
    ...
    int QCOM_filter_cubic_clamp;
    int QCOM_filter_cubic_weights;
    int QCOM_fragment_density_map_offset;
    int QCOM_image_processing;
    int QCOM_image_processing2;
